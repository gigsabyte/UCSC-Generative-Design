...
const asg2 = ( p ) => {
  ...
  p.preload = function() {
    ...
    deepWaterTex = p.loadImage('assets/imgs/deepwater.png');
    waterTex = p.loadImage('assets/imgs/water.gif');
    sandTex = p.loadImage('assets/imgs/sand.png');
    grassTex = p.loadImage('assets/imgs/grass.png');
    rockTex = p.loadImage('assets/imgs/rock.png');
    snowTex = p.loadImage('assets/imgs/snow.png');

    skyTex = p.loadImage('assets/imgs/sky.png');
  }
  ...
  p.setup = function() {
    ...
    // put textures into an array
    textures = [deepWaterTex, waterTex, sandTex, grassTex, rockTex, snowTex];

    // instantiate world generator
    wg = new WorldGenerator(width, height, depth, seed, textures, this);
  ...
  p.draw = function() {
    ...
    // set up lights
    p.ambientLight(150, 120, 150);
    p.directionalLight(105, 135, 105, 0.5, 1, 0);
